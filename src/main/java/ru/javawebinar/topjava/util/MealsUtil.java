...
public class MealsUtil {
    ...
    public static final List<Meal> mealsAdmin = Arrays.asList(
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 14, 0), "Admin Lunch", 600),
            new Meal(LocalDateTime.of(2020, Month.FEBRUARY, 1, 9, 0), "Admin Breakfast", 400),
            new Meal(LocalDateTime.of(2020, Month.FEBRUARY, 1, 20, 0), "Admin Dinner", 800)
    );
    ...
    public static List<MealTo> getFilteredByDateTos(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
